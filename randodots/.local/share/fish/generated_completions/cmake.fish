...
complete -c cmake -l toolchain -d 'New in version 3. 21'
complete -c cmake -l install-prefix -d 'New in version 3. 21'
...
complete -c cmake -l debug-find -d 'New in version 3. 17.  Put cmake find commands in a debug mode'
complete -c cmake -l debug-find-pkg -d 'New in version 3. 23'
complete -c cmake -l debug-find-var -d 'New in version 3. 23'
complete -c cmake -l trace -d 'Put cmake in trace mode'
complete -c cmake -l trace-expand -d 'Put cmake in trace mode'
complete -c cmake -l trace-format -d 'New in version 3. 17'
...
complete -c cmake -l compile-no-warning-as-error -d 'New in version 3. 24'
complete -c cmake -l profiling-output -d 'New in version 3. 18'
